...
fixture `Fragment :: 160 .makeFragmentClass()`
  .page(appRootPath.path + '/test/fixtures/fragment/160-make-fragment-class.html');

test("010 It should throw error when 'options.stateParts' argument is not an array", async () => {
  let isThrown = false;
